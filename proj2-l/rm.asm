...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 59 08 00 00       	mov    $0x859,%ebx
        while(*s != 0){
 ...
 621:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 70 0b 00 00       	mov    %eax,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 70 0b 00 00    	mov    0xb70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 70 0b 00 00    	cmp    %eax,0xb70
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 777:	0b 00 00 
 77a:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 781:	0b 00 00 
    base.s.size = 0;
 784:	b8 74 0b 00 00       	mov    $0xb74,%eax
 789:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 790:	00 00 00 
