...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 5f 08 00 00       	mov    $0x85f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 78 0b 00 00       	mov    0xb78,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 78 0b 00 00       	mov    %eax,0xb78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 78 0b 00 00    	mov    0xb78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 78 0b 00 00    	cmp    %eax,0xb78
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 78 0b 00 00    	mov    0xb78,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 78 0b 00 00    	mov    %edx,0xb78
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 78 0b 00 00 7c 	movl   $0xb7c,0xb78
 777:	0b 00 00 
 77a:	c7 05 7c 0b 00 00 7c 	movl   $0xb7c,0xb7c
 781:	0b 00 00 
    base.s.size = 0;
 784:	b8 7c 0b 00 00       	mov    $0xb7c,%eax
 789:	c7 05 80 0b 00 00 00 	movl   $0x0,0xb80
 790:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 7b6:	68 00 10 00 00       	push   $0x1000
 7bb:	e8 f0 fe ff ff       	call   6b0 <malloc>
    // printf(1,"malloc loc is %d",stack);

    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 7c0:	83 c4 0c             	add    $0xc,%esp
 7c3:	05 00 10 00 00       	add    $0x1000,%eax
 7c8:	ff 75 10             	pushl  0x10(%ebp)
 7cb:	50                   	push   %eax
 7cc:	ff 75 0c             	pushl  0xc(%ebp)
 7cf:	e8 a6 fb ff ff       	call   37a <clone>
 ...
 7d7:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 7da:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 7dc:	c1 f8 1f             	sar    $0x1f,%eax
 7df:	83 c8 01             	or     $0x1,%eax
}
 7e2:	c9                   	leave  
 7e3:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 7f3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 7f4:	e9 91 fb ff ff       	jmp    38a <thread_exit>
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000800 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 803:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 806:	8d 45 f4             	lea    -0xc(%ebp),%eax
 809:	50                   	push   %eax
 80a:	ff 75 0c             	pushl  0xc(%ebp)
 80d:	ff 75 08             	pushl  0x8(%ebp)
 810:	e8 6d fb ff ff       	call   382 <join>

    free((void *)((int)stack-4096));
 815:	8b 45 f4             	mov    -0xc(%ebp),%eax
 818:	2d 00 10 00 00       	sub    $0x1000,%eax
 81d:	89 04 24             	mov    %eax,(%esp)
 820:	e8 fb fd ff ff       	call   620 <free>
}
