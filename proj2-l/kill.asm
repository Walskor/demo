...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 20 08 00 00       	mov    $0x820,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 34 0b 00 00       	mov    %eax,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 34 0b 00 00    	mov    0xb34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 34 0b 00 00    	cmp    %eax,0xb34
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 757:	0b 00 00 
 75a:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 761:	0b 00 00 
    base.s.size = 0;
 764:	b8 38 0b 00 00       	mov    $0xb38,%eax
 769:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 770:	00 00 00 
