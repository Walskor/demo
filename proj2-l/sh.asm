...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 a0 19 00 00       	push   $0x19a0
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d a0 19 00 00 63 	cmpb   $0x63,0x19a0
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d a1 19 00 00 64 	cmpb   $0x64,0x19a1
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 a3 19 00 00       	push   $0x19a3
      ec:	68 15 13 00 00       	push   $0x1315
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 6c 12 00 00       	push   $0x126c
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 09 13 00 00       	push   $0x1309
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 24 13 00 00 	jmp    *0x1324(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 76 12 00 00       	push   $0x1276
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 86 12 00 00       	push   $0x1286
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 6f 12 00 00       	push   $0x126f
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 96 12 00 00       	push   $0x1296
     ...
     2d8:	68 9b 12 00 00       	push   $0x129b
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 96 12 00 00       	push   $0x1296
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 bd 12 00 00       	push   $0x12bd
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 a0 12 00 00       	push   $0x12a0
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 c0 12 00 00       	push   $0x12c0
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 d7 12 00 00       	push   $0x12d7
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 c9 12 00 00       	push   $0x12c9
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 c2 12 00 00       	push   $0x12c2
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 dc 12 00 00       	push   $0x12dc
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 de 12 00 00       	push   $0x12de
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 da 12 00 00       	push   $0x12da
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 c0 12 00 00       	push   $0x12c0
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 fc 12 00 00       	push   $0x12fc
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 3c 13 00 00 	jmp    *0x133c(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 85 12 00 00       	push   $0x1285
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 fe 12 00 00       	push   $0x12fe
     aa6:	6a 02                	push   $0x2
     aa8:	e8 e3 03 00 00       	call   e90 <printf>
    panic("syntax");
     aad:	c7 04 24 c2 12 00 00 	movl   $0x12c2,(%esp)
     ...
     df9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e27:	f7 f1                	div    %ecx
     e29:	0f b6 92 5c 13 00 00 	movzbl 0x135c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1044:	e9 8f fe ff ff       	jmp    ed8 <printf+0x48>
          s = "(null)";
    1049:	bb 54 13 00 00       	mov    $0x1354,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1061:	a1 04 1a 00 00       	mov    0x1a04,%eax
{
  ...
  freep = p;
    109f:	a3 04 1a 00 00       	mov    %eax,0x1a04
}
    10a4:	5b                   	pop    %ebx
    10a5:	5e                   	pop    %esi
    10a6:	5f                   	pop    %edi
    ...
    10b6:	72 ce                	jb     1086 <free+0x26>
{
  ...
  freep = p;
    10da:	a3 04 1a 00 00       	mov    %eax,0x1a04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10fc:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1141:	39 05 04 1a 00 00    	cmp    %eax,0x1a04
  ...
  return freep;
    116b:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
    ...
    1194:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1197:	89 15 04 1a 00 00    	mov    %edx,0x1a04
}
    ...
    base.s.ptr = freep = prevp = &base;
    11b0:	c7 05 04 1a 00 00 08 	movl   $0x1a08,0x1a04
    11b7:	1a 00 00 
    11ba:	c7 05 08 1a 00 00 08 	movl   $0x1a08,0x1a08
    11c1:	1a 00 00 
    base.s.size = 0;
    11c4:	b8 08 1a 00 00       	mov    $0x1a08,%eax
    11c9:	c7 05 0c 1a 00 00 00 	movl   $0x0,0x1a0c
    11d0:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
    ...
    11f3:	83 ec 14             	sub    $0x14,%esp
    // add your implementation here ...
    void * stack = (void *)malloc(4096);
    11f6:	68 00 10 00 00       	push   $0x1000
    11fb:	e8 f0 fe ff ff       	call   10f0 <malloc>
    // printf(1,"malloc loc is %d",stack);

    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
    1200:	83 c4 0c             	add    $0xc,%esp
    1203:	05 00 10 00 00       	add    $0x1000,%eax
    1208:	ff 75 10             	pushl  0x10(%ebp)
    120b:	50                   	push   %eax
    120c:	ff 75 0c             	pushl  0xc(%ebp)
    120f:	e8 a6 fb ff ff       	call   dba <clone>
    ...
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
    121a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
    121c:	c1 f8 1f             	sar    $0x1f,%eax
    121f:	83 c8 01             	or     $0x1,%eax
}
    1222:	c9                   	leave  
    1223:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
   ...
   thread_exit(ret_val_p);
    ...
    1233:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
    1234:	e9 91 fb ff ff       	jmp    dca <thread_exit>
    1239:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00001240 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
    ...
    1243:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
    1246:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1249:	50                   	push   %eax
    124a:	ff 75 0c             	pushl  0xc(%ebp)
    124d:	ff 75 08             	pushl  0x8(%ebp)
    1250:	e8 6d fb ff ff       	call   dc2 <join>

    free((void *)((int)stack-4096));
    1255:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1258:	2d 00 10 00 00       	sub    $0x1000,%eax
    125d:	89 04 24             	mov    %eax,(%esp)
    1260:	e8 fb fd ff ff       	call   1060 <free>
}
