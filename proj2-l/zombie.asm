...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb dc 07 00 00       	mov    $0x7dc,%ebx
        while(*s != 0){
 ...
 5d1:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 e8 0a 00 00       	mov    %eax,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 727:	0a 00 00 
 72a:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 739:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 740:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 778:	ff 75 10             	pushl  0x10(%ebp)
 77b:	50                   	push   %eax
 77c:	ff 75 0c             	pushl  0xc(%ebp)
 77f:	e8 a6 fb ff ff       	call   32a <clone>
 ...
 787:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 78a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 78c:	c1 f8 1f             	sar    $0x1f,%eax
 78f:	83 c8 01             	or     $0x1,%eax
}
 792:	c9                   	leave  
 793:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 7a3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 7a4:	e9 91 fb ff ff       	jmp    33a <thread_exit>
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000007b0 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 7b3:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 7b6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 7b9:	50                   	push   %eax
 7ba:	ff 75 0c             	pushl  0xc(%ebp)
 7bd:	ff 75 08             	pushl  0x8(%ebp)
 7c0:	e8 6d fb ff ff       	call   332 <join>

    free((void *)((int)stack-4096));
 7c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7c8:	2d 00 10 00 00       	sub    $0x1000,%eax
 7cd:	89 04 24             	mov    %eax,(%esp)
 7d0:	e8 fb fd ff ff       	call   5d0 <free>
}
