...
main(int argc, char *argv[])
{
  ...
  28:	68 1c 08 00 00       	push   $0x81c
  2d:	50                   	push   %eax
  2e:	68 1e 08 00 00       	push   $0x81e
  33:	6a 01                	push   $0x1
  ...
  47:	68 23 08 00 00       	push   $0x823
  4c:	50                   	push   %eax
  4d:	68 1e 08 00 00       	push   $0x81e
  52:	6a 01                	push   $0x1
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 25 08 00 00       	mov    $0x825,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 38 0b 00 00       	mov    %eax,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 38 0b 00 00    	mov    0xb38,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 38 0b 00 00    	cmp    %eax,0xb38
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 767:	0b 00 00 
 76a:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 771:	0b 00 00 
    base.s.size = 0;
 774:	b8 3c 0b 00 00       	mov    $0xb3c,%eax
 779:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 780:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 7a6:	68 00 10 00 00       	push   $0x1000
 7ab:	e8 f0 fe ff ff       	call   6a0 <malloc>
 ...
 7b8:	ff 75 10             	pushl  0x10(%ebp)
 7bb:	50                   	push   %eax
 7bc:	ff 75 0c             	pushl  0xc(%ebp)
 7bf:	e8 a6 fb ff ff       	call   36a <clone>
 ...
 7c7:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 7ca:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 7cc:	c1 f8 1f             	sar    $0x1f,%eax
 7cf:	83 c8 01             	or     $0x1,%eax
}
 7d2:	c9                   	leave  
 7d3:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 7e3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 7e4:	e9 91 fb ff ff       	jmp    37a <thread_exit>
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000007f0 <xthread_join>:
