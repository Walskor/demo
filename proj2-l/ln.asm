...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 33 08 00 00       	mov    $0x833,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 44 0b 00 00       	mov    %eax,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 44 0b 00 00    	mov    0xb44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 44 0b 00 00    	cmp    %eax,0xb44
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 757:	0b 00 00 
 75a:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 761:	0b 00 00 
    base.s.size = 0;
 764:	b8 48 0b 00 00       	mov    $0xb48,%eax
 769:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 770:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 7b7:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 7ba:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 7bc:	c1 f8 1f             	sar    $0x1f,%eax
 7bf:	83 c8 01             	or     $0x1,%eax
}
 7c2:	c9                   	leave  
 7c3:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 7d3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 7d4:	e9 91 fb ff ff       	jmp    36a <thread_exit>
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000007e0 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 7f0:	e8 6d fb ff ff       	call   362 <join>

    free((void *)((int)stack-4096));
 7f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7f8:	2d 00 10 00 00       	sub    $0x1000,%eax
 7fd:	89 04 24             	mov    %eax,(%esp)
 800:	e8 fb fd ff ff       	call   600 <free>
}
