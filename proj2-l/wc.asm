 ...
 4b9:	85 d2                	test   %edx,%edx
{
 ...
 4e7:	f7 f1                	div    %ecx
 4e9:	0f b6 92 6c 09 00 00 	movzbl 0x96c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 704:	e9 8f fe ff ff       	jmp    598 <printf+0x48>
          s = "(null)";
 709:	bb 63 09 00 00       	mov    $0x963,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 c0 0c 00 00       	mov    0xcc0,%eax
{
 ...
 75d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 75f:	a3 c0 0c 00 00       	mov    %eax,0xcc0
}
 764:	5b                   	pop    %ebx
 765:	5e                   	pop    %esi
 766:	5f                   	pop    %edi
 ...
 776:	72 ce                	jb     746 <free+0x26>
{
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 c0 0c 00 00       	mov    %eax,0xcc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 15 c0 0c 00 00    	mov    0xcc0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 47                	jae    848 <malloc+0x98>
    ...
    if(p == freep)
 801:	39 05 c0 0c 00 00    	cmp    %eax,0xcc0
 ...
 826:	e8 f5 fe ff ff       	call   720 <free>
  return freep;
 82b:	8b 15 c0 0c 00 00    	mov    0xcc0,%edx
 ...
 854:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 857:	89 15 c0 0c 00 00    	mov    %edx,0xcc0
}
 ...
 869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 c0 0c 00 00 c4 	movl   $0xcc4,0xcc0
 877:	0c 00 00 
 87a:	c7 05 c4 0c 00 00 c4 	movl   $0xcc4,0xcc4
 881:	0c 00 00 
    base.s.size = 0;
 884:	b8 c4 0c 00 00       	mov    $0xcc4,%eax
 889:	c7 05 c8 0c 00 00 00 	movl   $0x0,0xcc8
 890:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 8b6:	68 00 10 00 00       	push   $0x1000
 8bb:	e8 f0 fe ff ff       	call   7b0 <malloc>
    // printf(1,"malloc loc is %d",stack);

    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 8c0:	83 c4 0c             	add    $0xc,%esp
 8c3:	05 00 10 00 00       	add    $0x1000,%eax
 8c8:	ff 75 10             	pushl  0x10(%ebp)
 8cb:	50                   	push   %eax
 8cc:	ff 75 0c             	pushl  0xc(%ebp)
 8cf:	e8 a6 fb ff ff       	call   47a <clone>
 ...
 8da:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 8dc:	c1 f8 1f             	sar    $0x1f,%eax
 8df:	83 c8 01             	or     $0x1,%eax
}
 8e2:	c9                   	leave  
 8e3:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 8f3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 8f4:	e9 91 fb ff ff       	jmp    48a <thread_exit>
 8f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000900 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 903:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 906:	8d 45 f4             	lea    -0xc(%ebp),%eax
 909:	50                   	push   %eax
 90a:	ff 75 0c             	pushl  0xc(%ebp)
 90d:	ff 75 08             	pushl  0x8(%ebp)
 910:	e8 6d fb ff ff       	call   482 <join>

    free((void *)((int)stack-4096));
 915:	8b 45 f4             	mov    -0xc(%ebp),%eax
 918:	2d 00 10 00 00       	sub    $0x1000,%eax
 91d:	89 04 24             	mov    %eax,(%esp)
 920:	e8 fb fd ff ff       	call   720 <free>
}
