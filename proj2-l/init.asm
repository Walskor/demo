...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 fc 0b 00 00       	push   $0xbfc
  ab:	68 ca 08 00 00       	push   $0x8ca
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 cd 08 00 00       	push   $0x8cd
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 9c 08 00 00       	push   $0x89c
  d2:	e8 b3 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 9c 08 00 00       	push   $0x89c
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 f4 08 00 00 	movzbl 0x8f4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb ec 08 00 00       	mov    $0x8ec,%ebx
        while(*s != 0){
 ...
 691:	a1 04 0c 00 00       	mov    0xc04,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 04 0c 00 00       	mov    %eax,0xc04
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 ...
 6e6:	72 ce                	jb     6b6 <free+0x26>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 04 0c 00 00       	mov    %eax,0xc04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 04 0c 00 00    	cmp    %eax,0xc04
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 04 0c 00 00    	mov    0xc04,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 04 0c 00 00    	mov    %edx,0xc04
}
 ...
 7e7:	0c 00 00 
 7ea:	c7 05 08 0c 00 00 08 	movl   $0xc08,0xc08
 7f1:	0c 00 00 
    base.s.size = 0;
 7f4:	b8 08 0c 00 00       	mov    $0xc08,%eax
 7f9:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 800:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 847:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 84a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 84c:	c1 f8 1f             	sar    $0x1f,%eax
 84f:	83 c8 01             	or     $0x1,%eax
}
 852:	c9                   	leave  
 853:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 863:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 864:	e9 91 fb ff ff       	jmp    3fa <thread_exit>
 869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000870 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 873:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 876:	8d 45 f4             	lea    -0xc(%ebp),%eax
 879:	50                   	push   %eax
 87a:	ff 75 0c             	pushl  0xc(%ebp)
 87d:	ff 75 08             	pushl  0x8(%ebp)
 880:	e8 6d fb ff ff       	call   3f2 <join>

    free((void *)((int)stack-4096));
 885:	8b 45 f4             	mov    -0xc(%ebp),%eax
 888:	2d 00 10 00 00       	sub    $0x1000,%eax
 88d:	89 04 24             	mov    %eax,(%esp)
 890:	e8 fb fd ff ff       	call   690 <free>
}
