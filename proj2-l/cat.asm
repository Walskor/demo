...
printf(int fd, char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb f4 08 00 00       	mov    $0x8f4,%ebx
        while(*s != 0){
 ...
 6b1:	a1 40 0c 00 00       	mov    0xc40,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 40 0c 00 00       	mov    %eax,0xc40
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 40 0c 00 00       	mov    %eax,0xc40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 40 0c 00 00    	mov    0xc40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 40 0c 00 00    	cmp    %eax,0xc40
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 40 0c 00 00    	mov    0xc40,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 40 0c 00 00    	mov    %edx,0xc40
}
 ...
 807:	0c 00 00 
 80a:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 811:	0c 00 00 
    base.s.size = 0;
 814:	b8 44 0c 00 00       	mov    $0xc44,%eax
 819:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 820:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 858:	ff 75 10             	pushl  0x10(%ebp)
 85b:	50                   	push   %eax
 85c:	ff 75 0c             	pushl  0xc(%ebp)
 85f:	e8 a6 fb ff ff       	call   40a <clone>
 ...
 867:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 86a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 86c:	c1 f8 1f             	sar    $0x1f,%eax
 86f:	83 c8 01             	or     $0x1,%eax
}
 872:	c9                   	leave  
 873:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 883:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 884:	e9 91 fb ff ff       	jmp    41a <thread_exit>
 889:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000890 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 893:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 896:	8d 45 f4             	lea    -0xc(%ebp),%eax
 899:	50                   	push   %eax
 89a:	ff 75 0c             	pushl  0xc(%ebp)
 89d:	ff 75 08             	pushl  0x8(%ebp)
 8a0:	e8 6d fb ff ff       	call   412 <join>

    free((void *)((int)stack-4096));
 8a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8a8:	2d 00 10 00 00       	sub    $0x1000,%eax
 8ad:	89 04 24             	mov    %eax,(%esp)
 8b0:	e8 fb fd ff ff       	call   6b0 <free>
}
