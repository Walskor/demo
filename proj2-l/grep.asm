 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 40 0f 00 00    	lea    0xf40(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 40 0f 00 00       	mov    $0xf40,%ebx
    buf[m] = '\0';
 26c:	c6 86 40 0f 00 00 00 	movb   $0x0,0xf40(%esi)
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 40 0f 00 00       	sub    $0xf40,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 40 0f 00 00       	push   $0xf40
...
00000642 <set_priority>:
SYSCALL(set_priority)
 642:	b8 1a 00 00 00       	mov    $0x1a,%eax
 647:	cd 40                	int    $0x40
 649:	c3                   	ret    

0000064a <enable_sched_display>:
...
printf(int fd, char *fmt, ...)
{
 ...
 8b4:	e9 8f fe ff ff       	jmp    748 <printf+0x48>
          s = "(null)";
 8b9:	bb 12 0b 00 00       	mov    $0xb12,%ebx
        while(*s != 0){
 ...
 8d1:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 90d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 90f:	a3 20 0f 00 00       	mov    %eax,0xf20
}
 914:	5b                   	pop    %ebx
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
 ...
 926:	72 ce                	jb     8f6 <free+0x26>
{
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 94a:	a3 20 0f 00 00       	mov    %eax,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 15 20 0f 00 00    	mov    0xf20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9af:	73 47                	jae    9f8 <malloc+0x98>
    ...
    if(p == freep)
 9b1:	39 05 20 0f 00 00    	cmp    %eax,0xf20
 ...
 9d6:	e8 f5 fe ff ff       	call   8d0 <free>
  return freep;
 9db:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 a04:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a07:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 a27:	0f 00 00 
 a2a:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 a31:	0f 00 00 
    base.s.size = 0;
 a34:	b8 24 0f 00 00       	mov    $0xf24,%eax
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 a87:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 a8a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 a8c:	c1 f8 1f             	sar    $0x1f,%eax
 a8f:	83 c8 01             	or     $0x1,%eax
}
 a92:	c9                   	leave  
 a93:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 aa3:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 aa4:	e9 91 fb ff ff       	jmp    63a <thread_exit>
 aa9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000ab0 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 ab3:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 ab6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 ab9:	50                   	push   %eax
 aba:	ff 75 0c             	pushl  0xc(%ebp)
 abd:	ff 75 08             	pushl  0x8(%ebp)
 ac0:	e8 6d fb ff ff       	call   632 <join>

    free((void *)((int)stack-4096));
 ac5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ac8:	2d 00 10 00 00       	sub    $0x1000,%eax
 acd:	89 04 24             	mov    %eax,(%esp)
 ad0:	e8 fb fd ff ff       	call   8d0 <free>
}
