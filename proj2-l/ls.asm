...
00000060 <fmtname>:
{
  ...
  d7:	05 b0 0e 00 00       	add    $0xeb0,%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 8b4:	e9 8f fe ff ff       	jmp    748 <printf+0x48>
          s = "(null)";
 8b9:	bb 26 0b 00 00       	mov    $0xb26,%ebx
        while(*s != 0){
