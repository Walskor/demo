...
main(int argc, char *argv[])
{
  ...
  shutdown();
  11:	e8 fc 02 00 00       	call   312 <shutdown>
  exit();
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 d4 07 00 00 	movzbl 0x7d4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb cc 07 00 00       	mov    $0x7cc,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 d8 0a 00 00       	mov    %eax,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 717:	0a 00 00 
 71a:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 dc 0a 00 00       	mov    $0xadc,%eax
 729:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 730:	00 00 00 
...
int xthread_create(int * tid, void * (* start_routine)(void *), void * arg)
{
 ...
 777:	83 c4 10             	add    $0x10,%esp
    (*tid) = clone(start_routine, (void*)((int)stack+4096), arg);
 77a:	89 02                	mov    %eax,(%edx)
        return -1;
    return 1;
 77c:	c1 f8 1f             	sar    $0x1f,%eax
 77f:	83 c8 01             	or     $0x1,%eax
}
 782:	c9                   	leave  
 783:	c3                   	ret    
...
void xthread_exit(void * ret_val_p)
{
 ...
 793:	5d                   	pop    %ebp
   thread_exit(ret_val_p);
 794:	e9 91 fb ff ff       	jmp    32a <thread_exit>
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000007a0 <xthread_join>:
...
void xthread_join(int tid, void ** retval)
{
 ...
 7a3:	83 ec 1c             	sub    $0x1c,%esp
    // add your implementation here ...
    void * stack;
    join(tid, retval, &stack);
 7a6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 7a9:	50                   	push   %eax
 7aa:	ff 75 0c             	pushl  0xc(%ebp)
 7ad:	ff 75 08             	pushl  0x8(%ebp)
 7b0:	e8 6d fb ff ff       	call   322 <join>

    free((void *)((int)stack-4096));
 7b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7b8:	2d 00 10 00 00       	sub    $0x1000,%eax
 7bd:	89 04 24             	mov    %eax,(%esp)
 7c0:	e8 fb fd ff ff       	call   5c0 <free>
}
