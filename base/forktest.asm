...
main(void)
{
  ...
  forktest();
  11:	e8 0a 00 00 00       	call   20 <forktest>
  exit();
  ...
  24:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  29:	68 e8 07 00 00       	push   $0x7e8
  2e:	6a 01                	push   $0x1
  30:	e8 5b 04 00 00       	call   490 <printf>
  35:	83 c4 10             	add    $0x10,%esp
  38:	eb 13                	jmp    4d <forktest+0x2d>
  3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(pid == 0)
  40:	74 67                	je     a9 <forktest+0x89>
  for(n=0; n<N; n++){
  42:	83 c3 01             	add    $0x1,%ebx
  45:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  4b:	74 43                	je     90 <forktest+0x70>
    pid = fork();
  4d:	e8 d8 02 00 00       	call   32a <fork>
    if(pid < 0)
  ...
  5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(wait() < 0){
  60:	e8 d5 02 00 00       	call   33a <wait>
  65:	85 c0                	test   %eax,%eax
  67:	78 45                	js     ae <forktest+0x8e>
  for(; n > 0; n--){
  69:	83 eb 01             	sub    $0x1,%ebx
  6c:	75 f2                	jne    60 <forktest+0x40>
  if(wait() != -1){
  6e:	e8 c7 02 00 00       	call   33a <wait>
  73:	83 f8 ff             	cmp    $0xffffffff,%eax
  76:	75 4a                	jne    c2 <forktest+0xa2>
  printf(1, "fork test OK\n");
  78:	83 ec 08             	sub    $0x8,%esp
  7b:	68 1a 08 00 00       	push   $0x81a
  80:	6a 01                	push   $0x1
  ...
  93:	68 e8 03 00 00       	push   $0x3e8
  98:	68 28 08 00 00       	push   $0x828
  9d:	6a 01                	push   $0x1
  9f:	e8 ec 03 00 00       	call   490 <printf>
    exit();
  a4:	e8 89 02 00 00       	call   332 <exit>
      exit();
  a9:	e8 84 02 00 00       	call   332 <exit>
      printf(1, "wait stopped early\n");
  ae:	83 ec 08             	sub    $0x8,%esp
  b1:	68 f3 07 00 00       	push   $0x7f3
  b6:	6a 01                	push   $0x1
  b8:	e8 d3 03 00 00       	call   490 <printf>
      exit();
  bd:	e8 70 02 00 00       	call   332 <exit>
    printf(1, "wait got too many\n");
  c2:	50                   	push   %eax
  c3:	50                   	push   %eax
  c4:	68 07 08 00 00       	push   $0x807
  c9:	6a 01                	push   $0x1
  cb:	e8 c0 03 00 00       	call   490 <printf>
    exit();
  d0:	e8 5d 02 00 00       	call   332 <exit>
  d5:	66 90                	xchg   %ax,%ax
  d7:	66 90                	xchg   %ax,%ax
  d9:	66 90                	xchg   %ax,%ax
  db:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
