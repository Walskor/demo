...
_stresstest:     file format elf32-i386
...
main(int argc, char *argv[]){       
  ...
  11:	e8 b4 03 00 00       	call   3ca <get_free_frame_cnt>
  16:	89 45 e8             	mov    %eax,-0x18(%ebp)
    for(n=0;n<64;n++){
  19:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  20:	eb 3d                	jmp    5f <main+0x5f>
      // bef = get_free_frame_cnt();
      pid=fork();
  22:	e8 f3 02 00 00       	call   31a <fork>
  27:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      // aff = get_free_frame_cnt();
      // printf(1,"====================  %d\n",bef-aff); 
      if(pid==0){
  2a:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  2e:	75 25                	jne    55 <main+0x55>
        // bef = get_free_frame_cnt();
        // printf(1,"\nnow turn: %d \n before data change: %d",n+1,get_free_frame_cnt());
        data[0]='a';   
  30:	c7 05 e0 0a 00 00 61 	movl   $0x61,0xae0
  37:	00 00 00 
        for(int i = 0 ; i < 1000000;i++);
  3a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  41:	eb 04                	jmp    47 <main+0x47>
  43:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  47:	81 7d ec 3f 42 0f 00 	cmpl   $0xf423f,-0x14(%ebp)
  4e:	7e f3                	jle    43 <main+0x43>
        // aff = get_free_frame_cnt();
        // printf(1,"========== in %d , bef-aff = %d\n",n+1,bef-aff); 
        exit();
  50:	e8 cd 02 00 00       	call   322 <exit>
      }else if(pid<0)
  55:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  59:	78 0c                	js     67 <main+0x67>
    for(n=0;n<64;n++){
  5b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  5f:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
  63:	7e bd                	jle    22 <main+0x22>
  65:	eb 01                	jmp    68 <main+0x68>
        break;
  67:	90                   	nop
  ...
  6e:	68 d8 07 00 00       	push   $0x7d8
  73:	6a 01                	push   $0x1
  75:	e8 06 04 00 00       	call   480 <printf>
  7a:	83 c4 10             	add    $0x10,%esp
    while(i<0xfffffff)i++; //wait for some time
  7d:	eb 04                	jmp    83 <main+0x83>
  7f:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  83:	81 7d f0 fe ff ff 0f 	cmpl   $0xffffffe,-0x10(%ebp)
  8a:	7e f3                	jle    7f <main+0x7f>
    post=get_free_frame_cnt();
  8c:	e8 39 03 00 00       	call   3ca <get_free_frame_cnt>
  91:	89 45 e0             	mov    %eax,-0x20(%ebp)
    while(n--)wait();
  94:	eb 05                	jmp    9b <main+0x9b>
  96:	e8 8f 02 00 00       	call   32a <wait>
  9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  9e:	8d 50 ff             	lea    -0x1(%eax),%edx
  a1:	89 55 f4             	mov    %edx,-0xc(%ebp)
  a4:	85 c0                	test   %eax,%eax
  a6:	75 ee                	jne    96 <main+0x96>
    printf(1,"pre: %d, post: %d\n",pre,post);    
  a8:	ff 75 e0             	pushl  -0x20(%ebp)
  ab:	ff 75 e8             	pushl  -0x18(%ebp)
  ae:	68 f4 07 00 00       	push   $0x7f4
  b3:	6a 01                	push   $0x1
  b5:	e8 c6 03 00 00       	call   480 <printf>
  ba:	83 c4 10             	add    $0x10,%esp
    exit();
  bd:	e8 60 02 00 00       	call   322 <exit>
  c2:	66 90                	xchg   %ax,%ax
  c4:	66 90                	xchg   %ax,%ax
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
